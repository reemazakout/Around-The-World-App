...
const activeCircleStyles =
  "w-h h-5 rounded-full flex justify-center items-center p-[3px]";
...
export default function ThemeSwitcher() {
  ...
  return (
    <>
      <div className="flex h-[31px] w-[57px] items-center justify-center gap-1 rounded-full bg-primary">
        <button
        ...
        <button
          className={`${activeCircleStyles} ${
            theme === "dark" ? "bg-white text-gray-800" : "text-white"
          }`}
          onClick={handleThemeChange}
        >
          <svg
